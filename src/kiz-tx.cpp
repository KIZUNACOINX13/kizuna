...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Kizuna Core kiz-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  kiz-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kiz transaction") + "\n" +
                               "  kiz-tx [options] -create [commands]   " + _("Create hex-encoded kiz transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded kiz transaction
