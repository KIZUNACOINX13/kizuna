...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Kiz features */
        {"kiz", "masternode", &masternode, true, true, false},
        {"kiz", "listmasternodes", &listmasternodes, true, true, false},
        {"kiz", "getmasternodecount", &getmasternodecount, true, true, false},
        {"kiz", "masternodeconnect", &masternodeconnect, true, true, false},
        {"kiz", "masternodecurrent", &masternodecurrent, true, true, false},
        {"kiz", "masternodedebug", &masternodedebug, true, true, false},
        {"kiz", "startmasternode", &startmasternode, true, true, false},
        {"kiz", "createmasternodekey", &createmasternodekey, true, true, false},
        {"kiz", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"kiz", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"kiz", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"kiz", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"kiz", "getmasternodescores", &getmasternodescores, true, true, false},
        {"kiz", "mnbudget", &mnbudget, true, true, false},
        {"kiz", "preparebudget", &preparebudget, true, true, false},
        {"kiz", "submitbudget", &submitbudget, true, true, false},
        {"kiz", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"kiz", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"kiz", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"kiz", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"kiz", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"kiz", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"kiz", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"kiz", "checkbudgets", &checkbudgets, true, true, false},
        {"kiz", "mnsync", &mnsync, true, true, false},
        {"kiz", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> kiz-cli " + methodname + " " + args + "\n";
}
