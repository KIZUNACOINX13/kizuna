...
/* Kiz GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Kiz"
#define QAPP_ORG_DOMAIN "kizunacoin.io"
#define QAPP_APP_NAME_DEFAULT "Kiz-Qt"
#define QAPP_APP_NAME_TESTNET "Kiz-Qt-testnet"
