                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Kizuna Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a KIZ address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and kiz: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Kizuna Core"), this);
    aboutAction->setStatusTip(tr("Show information about Kizuna Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Kiz"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your KIZ addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified KIZ addresses"));
    ...
    openAction->setStatusTip(tr("Open a kiz: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Kizuna Core help message to get a list with possible Kiz command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Kizuna Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Kiz network", "", count));
}
...
{
    QString strTitle = tr("Kizuna Core"); // default title
