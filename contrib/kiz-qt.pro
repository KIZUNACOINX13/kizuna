...
RESOURCES += src/qt/kiz.qrc src/qt/kiz_locale.qrc

TRANSLATIONS += src/qt/locale/kiz_bg.ts \
                src/qt/locale/kiz_de.ts \
                src/qt/locale/kiz_en.ts \
                src/qt/locale/kiz_es.ts \
                src/qt/locale/kiz_fi.ts \
                src/qt/locale/kiz_fr.ts \
                src/qt/locale/kiz_it.ts \
                src/qt/locale/kiz_ja.ts \
                src/qt/locale/kiz_pl.ts \
                src/qt/locale/kiz_pt.ts \
                src/qt/locale/kiz_ru.ts \
                src/qt/locale/kiz_sk.ts \
                src/qt/locale/kiz_sv.ts \
                src/qt/locale/kiz_vi.ts \
                src/qt/locale/kiz_zh_CN.ts \
                src/qt/locale/kiz_zh_TW.ts
