Contributing to Kizuna Core
==================================

The Kizuna Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Kizuna Core project, and is not to be
confused with overall Kiz Network Protocol consensus changes.

Whether a pull request is merged into Kizuna Core rests with the project merge
...
Patches that change Kiz consensus rules are considerably more involved than
...
Where a patch set proposes to change the Kiz consensus, it must have been
...
The project leader is the release manager for each Kizuna Core release.
