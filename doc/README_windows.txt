...
Intro
-----
Kiz (KIZ) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Kiz utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run kiz-qt.exe.

Kizuna Core is the original Kiz client and it builds the backbone of the network.
However, it downloads and stores the entire history of Kiz transactions;
