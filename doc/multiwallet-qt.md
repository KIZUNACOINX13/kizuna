...
In order to support loading of multiple wallets in kiz-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is kiz.cpp.
...
Changes to kiz.cpp
----------------------
kiz.cpp is the entry point into kiz-qt, and as such, will require some minor modifications to provide hooks for
