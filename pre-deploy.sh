...
cp $TRAVIS_BUILD_DIR/src/qt/kiz-qt $OUTDIR/bin/ || cp $TRAVIS_BUILD_DIR/src/qt/kiz-qt.exe $OUTDIR/bin/ || echo "no QT Wallet"
cp $TRAVIS_BUILD_DIR/src/kizd $OUTDIR/bin/ || cp $TRAVIS_BUILD_DIR/src/kizd.exe $OUTDIR/bin/
cp $TRAVIS_BUILD_DIR/src/kiz-cli $OUTDIR/bin/ || cp $TRAVIS_BUILD_DIR/src/kiz-cli.exe $OUTDIR/bin/
