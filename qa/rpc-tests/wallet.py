...
#   c) node1 mines 32 blocks, so now node 0 has 500000KIZ, node 1 has 4250KIZ, node2 has none.
#   d) node0 sends 601 KIZ to node2, in two transactions (301 KIZ, then 300 KIZ).
